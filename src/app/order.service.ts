...
export class OrderService {
  ...
  getOrders() {
    return this._http.get('https://trade-ravi.herokuapp.com/orders',{headers:{"authToken":this.token}});
  }

  getTrades() {
    return this._http.get('https://trade-ravi.herokuapp.com/trades',{headers:{"authToken":this.token}});
  }
}
